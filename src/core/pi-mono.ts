 ...
 * private fields. Mirrors openclaw's pi-embedded-runner/system-prompt.ts.
 *
...
export class AgentServiceCache {
  ...
  async createSession(opts: {
    ...
    // three fields directly on the session after creation. Mirrors openclaw's
    // applySystemPromptOverrideToSession (system-prompt.ts:99-111).
    //
    ...
    applySystemPromptOverrideToSession(session, opts.systemPrompt);
